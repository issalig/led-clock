 ...
 *----------------------------------------------------------------------*/
ButtonJC::ButtonJC(uint8_t pin, uint8_t puEnable, uint8_t invert, uint32_t dbTime)
{
    _pin = pin;
    _puEnable = puEnable;
    _invert = invert;
 ...
 *----------------------------------------------------------------------*/
uint8_t ButtonJC::isPressed(void)
{
    return _state == 0 ? 0 : 1;
}

uint8_t ButtonJC::isReleased(void)
{
    return _state == 0 ? 1 : 0;
}
 ...
 * These functions do not cause the button to be read.                  *
 *----------------------------------------------------------------------*/
uint8_t ButtonJC::wasPressed(void)
{
    return _state && _changed;
}

uint8_t ButtonJC::wasReleased(void)
{
    return !_state && _changed;
}
 ...
 * These functions do not cause the button to be read.                  *
 *----------------------------------------------------------------------*/
uint8_t ButtonJC::pressedFor(uint32_t ms)
{
    return (_state == 1 && _time - _lastChange >= ms) ? 1 : 0;
}

uint8_t ButtonJC::releasedFor(uint32_t ms)
{
 ...
 * in milliseconds.                                                     *
 *----------------------------------------------------------------------*/
uint32_t ButtonJC::lastChange(void)
{
    return _lastChange;
}
